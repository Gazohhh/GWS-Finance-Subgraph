...
export class OlympusStakingV1Helper extends ethereum.SmartContract {
  static bind(address: Address): OlympusStakingV1Helper {
    return new OlympusStakingV1Helper("OlympusStakingV1Helper", address);
  }
