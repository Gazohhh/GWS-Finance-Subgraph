...
export class GenerationalWealthSocietyStakingV1__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GenerationalWealthSocietyStakingV1__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class GenerationalWealthSocietyStakingV1 extends ethereum.SmartContract {
  static bind(address: Address): GenerationalWealthSocietyStakingV1 {
    return new GenerationalWealthSocietyStakingV1(
  ...
  epoch(): GenerationalWealthSocietyStakingV1__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new GenerationalWealthSocietyStakingV1__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<
    GenerationalWealthSocietyStakingV1__epochResult
  > {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new GenerationalWealthSocietyStakingV1__epochResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  sGWS(): Address {
    let result = super.call("sGWS", "sGWS():(address)", []);

    return result[0].toAddress();
  }

  try_sGWS(): ethereum.CallResult<Address> {
    let result = super.tryCall("sGWS", "sGWS():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(
    param0: Address
  ): GenerationalWealthSocietyStakingV1__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new GenerationalWealthSocietyStakingV1__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<GenerationalWealthSocietyStakingV1__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenerationalWealthSocietyStakingV1__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
